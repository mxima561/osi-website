...
export const SERVICES = [
  { slug: 'installation', short: 'Installation', title: 'Commercial Furniture Installation', icon: 'Building2', blurb: 'Experienced crews for projects ranging from single-office installs to multi-floor corporate deployments.', img: '/photos/service-tile-installation.jpg' },
  { slug: 'warehousing', short: 'Warehousing', title: 'Warehousing & Receiving', icon: 'Warehouse', blurb: 'Secure warehouse support for receiving, inspection, staging, storage, dispatch, and project coordination.', img: '/photos/service-tile-warehousing.jpg' },
  { slug: 'decommissioning', short: 'Decommissioning', title: 'Decommissioning & Relocation', icon: 'Recycle', blurb: 'Orderly furniture removal, relocation, and transition support with minimal disruption.', img: '/photos/service-tile-decommissioning.jpg' },
  { slug: 'asset-management-storage', short: 'Asset Management', title: 'Asset Management & Storage', icon: 'BarChart3', blurb: 'Tracked storage, inventory visibility, and redeployment support designed to extend the value of existing assets.', img: '/photos/service-tile-asset-management-storage.jpg' },
  { slug: 'modular-walls', short: 'Modular Walls', title: 'Modular Walls', icon: 'LayoutGrid', blurb: 'Installation support for demountable wall systems and modular environments requiring careful coordination and finish quality.', img: '/photos/service-tile-modular-walls.jpg' },
  { slug: 'mac-day2', short: 'MAC & Day 2', title: 'MAC & Day 2 Services', icon: 'RefreshCw', blurb: 'Ongoing support for moves, adds, changes, repairs, and day-to-day furniture needs.', img: '/photos/service-tile-mac-day2.jpg' },
];

export const INDUSTRIES = [
  { slug: 'corporate-office', title: 'Corporate Office', blurb: 'From private offices to multi-floor campuses, OSI supports the installations, reconfigurations, relocations, and ongoing service needs of active workplaces.', img: '/photos/ind-tile-corporate-office.jpg' },
  { slug: 'healthcare', title: 'Healthcare', blurb: 'OSI supports furniture projects in healthcare environments where coordination, cleanliness, and minimal disruption matter.', img: '/photos/ind-tile-healthcare.jpg' },
  { slug: 'education', title: 'Education', blurb: 'From administrative offices to classrooms, libraries, and campus facilities, OSI helps education clients complete furniture work on schedule and with care.', img: '/photos/ind-tile-education.jpg' },
  { slug: 'hospitality', title: 'Hospitality', blurb: 'OSI supports furniture installation, replacement, and transition work in hospitality environments where timing, presentation, and coordination are critical.', img: '/photos/ind-tile-hospitality.jpg' },
  { slug: 'government', title: 'Government', blurb: 'OSI provides dependable support for public-sector offices, departments, and facilities that require organized execution and a professional local partner.', img: '/photos/ind-tile-government.jpg' },
];
...
export const PROJECTS = [
  { id: 1, tag: 'Corporate', cat: 'Corporate', title: 'Corporate Campus Installation', result: 'Installed 220 workstations with curved monitors and privacy screens across 3 floors.', img: '/photos/project-corporate-campus.jpg' },
  { id: 2, tag: 'Corporate', cat: 'Corporate', title: 'Custom Furniture Installation', result: 'Received, delivered, and installed custom modular furniture for a national news station.', img: '/photos/project-custom-furniture.jpg' },
  { id: 3, tag: 'Education', cat: 'Education', title: 'Training Center Buildout', result: 'Reconfigured training room tables, power connections, and AV furniture with 24-hours notice.', img: '/photos/project-training-center.jpg' },
  { id: 4, tag: 'Corporate', cat: 'Corporate', title: 'Dedicated Asset Management', result: 'Over 25,000 sq ft of dedicated asset management space for a large publicly traded company.', img: '/photos/project-asset-management.jpg' },
  { id: 5, tag: 'Hospitality', cat: 'Hospitality', title: 'Sportsbook Installation', result: 'High-end sportsbook arena installation for a national basketball franchise.', img: '/photos/project-sportsbook.jpg' },
  { id: 6, tag: 'Corporate', cat: 'Corporate', title: 'Quad Privacy Booth', result: 'Installed phone booths and meeting pods across a 60,000 sq ft corporate floor.', img: '/photos/project-quad-booth.jpg' },
  { id: 7, tag: 'Corporate', cat: 'Corporate', title: 'Wire-Frame Pod & Lounge', result: 'Architectural pod and lounge seating installed in a new corporate lobby.', img: '/photos/project-wireframe-pod.jpg' },
  { id: 8, tag: 'Hospitality', cat: 'Hospitality', title: 'Café & Lounge Installation', result: 'Collaborative lounge, café seating, and booth furniture delivered for a corporate amenity space.', img: '/photos/project-cafe-lounge.jpg' },
  { id: 9, tag: 'Corporate', cat: 'Corporate', title: 'Downtown Tower Restack', result: 'Multi-floor workstation reconfiguration completed over three weekends with active employees.', img: '/photos/project-downtown-tower.jpg' },
];
...
export const SERVICE_PAGES = {
  'installation': {
    ...
    introImg: '/photos/svc-installation-overview.jpg',
    intro: [
  ...
  'warehousing': {
    ...
    introImg: '/photos/svc-warehousing-overview.jpg',
    intro: [
  ...
  'mac-day2': {
    ...
    introImg: '/photos/svc-mac-day2-overview.jpg',
    intro: [
    ...
    extra: { title: 'Who This Is For', sub: 'Teams who need dependable ongoing support.', img: '/photos/svc-mac-day2-extra.jpg', list: ['Enterprise clients and facility teams who need dependable local support','Dealers who want post-install service support for their clients','Organizations with growing, changing, or frequently reconfigured workplaces'] },
    whyTitle: 'Why Clients Use OSI',
    whyHeader: 'Ongoing work still needs a professional team',
    whyImg: '/photos/svc-mac-day2-why.jpg',
  ...
  'decommissioning': {
    ...
    introImg: '/photos/svc-decommissioning-overview.jpg',
    intro: [
    ...
    whyImg: '/photos/svc-decommissioning-why.jpg',
  ...
  'asset-management-storage': {
    ...
    introImg: '/photos/svc-asset-management-storage-overview.jpg',
    intro: [
    ...
    extra: { title: 'Why It Matters', sub: 'Better asset management protects past furniture investment.', body: 'When furniture is stored and tracked properly, clients have more options. They can reuse assets, support future moves, reduce waste, and avoid unnecessary replacement costs.', img: '/photos/svc-asset-management-storage-extra.jpg' },
    whyTitle: 'Why OSI',
    whyHeader: 'More than a place to put furniture',
    whyImg: '/photos/svc-asset-management-storage-why.jpg',
  ...
  'modular-walls': {
    ...
    introImg: '/photos/svc-modular-walls-overview.jpg',
    intro: [
    ...
    whyImg: '/photos/svc-modular-walls-why.jpg',
...
export const INDUSTRY_PAGES = {
  'corporate-office': {
    ...
    introImg: '/photos/ind-corporate-office-overview.jpg',
    ...
    whyImg: '/photos/ind-corporate-office-why.jpg',
    ...
    img: '/photos/ind-tile-corporate-office.jpg',
  },
  'healthcare': {
    ...
    introImg: '/photos/ind-healthcare-overview.jpg',
    ...
    whyImg: '/photos/ind-healthcare-why.jpg',
    ...
    img: '/photos/ind-tile-healthcare.jpg',
  },
  'education': {
    ...
    introImg: '/photos/ind-education-overview.jpg',
    ...
    whyImg: '/photos/ind-education-why.jpg',
    ...
    img: '/photos/ind-tile-education.jpg',
  },
  'hospitality': {
    ...
    introImg: '/photos/ind-hospitality-overview.jpg',
    ...
    whyImg: '/photos/ind-hospitality-why.jpg',
    ...
    img: '/photos/ind-tile-hospitality.jpg',
  },
  'government': {
    ...
    introImg: '/photos/ind-government-overview.jpg',
    ...
    whyImg: '/photos/ind-government-why.jpg',
    ...
    img: '/photos/ind-tile-government.jpg',
  },
};
