              ...
              <FadeIn key={p.id} delay={(i%6)*0.05}>
                <div className="group">
                  <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-[#EEEEE8] relative">
                    ...
                    <span className="absolute top-4 left-4 inline-flex items-center px-3 py-1 rounded-full bg-white/90 text-[#276a39] text-xs font-semibold tracking-wider uppercase">{p.tag}</span>
                  </div>
                  <h3 className="mt-5 font-display font-bold text-xl tracking-tight group-hover:text-[#2f7d44] transition">{p.title}</h3>
