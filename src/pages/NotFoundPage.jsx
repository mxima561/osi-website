    ...
    <Section className="py-32 md:py-48 bg-[#F9F9F5] min-h-[70vh] flex items-center">
      <Container>
        <div className="max-w-2xl">
          <div className="font-display font-black text-[120px] md:text-[180px] leading-none text-[#2f7d44] tracking-tighter">404</div>
          ...
          <div className="mt-10 flex flex-wrap gap-3 items-center">
            ...
            <Link to="/contact" className="text-sm font-semibold text-[#276a39] hover:text-[#1A1A1A]">or talk to us &rarr;</Link>
          </div>
        </div>
      </Container>
    </Section>
