        ...
        <FadeIn>
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-[#4A4A4A] leading-relaxed">
              ...
              <a href="mailto:requestaquote@osinstall.com" className="font-semibold text-[#0F1E3D] hover:text-[#6AA63F] transition">requestaquote@osinstall.com</a>
            ...
            <p className="mt-8 text-sm text-[#8A8A8A]">
              In a hurry? Call us directly at <a href="tel:+16022539392" className="font-semibold text-[#1A1A1A] hover:text-[#6AA63F]">(602) 253-9392</a>.
            </p>
          </div>
        </FadeIn>
      </Container>
